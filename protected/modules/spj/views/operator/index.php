...
echo CHtml::link(BHtml::icon('plus-sign').'Tambah SPM',array('create_spm'));

/*echo CHtml::link(BHtml::icon('download').'Export Excel','#',array('id'=>'xls','style'=>'float:right'));
Yii::app()->clientScript->registerCssFile('css/tableexport.css');
Yii::app()->clientScript->registerScriptFile('js/FileSaver.js');
Yii::app()->clientScript->registerScriptFile('js/tableexport.js');

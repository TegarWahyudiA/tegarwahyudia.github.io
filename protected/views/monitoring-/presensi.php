...
$prev = $mingguke<=1? CHtml::link('<i class="g g-chevron-left"></i>',array('presensi','tahun'=>$tahun-1,'mingguke'=>52)) : CHtml::link('<i class="g g-chevron-left"></i>',array('presensi','tahun'=>$tahun,'mingguke'=>((int)$mingguke<=10? '0'.($mingguke-1) : $mingguke-1)));
$next = $mingguke>=52? CHtml::link('<i class="g g-chevron-right"></i>',array('presensi','tahun'=>$tahun+1, 'mingguke'=>'01')) : CHtml::link('<i class="g g-chevron-right"></i>',array('presensi','tahun'=>$tahun, 'mingguke'=>((int)$mingguke<9?'0'.($mingguke+1) : $mingguke+1)));
...
$bulan = date('m', strtotime($tahun.'W'.$mingguke.'1'));

...
$this->widget('TbMenu', array(
	'type'=>'tabs',
	'items'=>array(
		array('label'=>'Capaian Kinerja','url'=>array('ckp_rekap','bulan'=>$bulan,'tahun'=>$tahun),'active'=>true),
		array('label'=>'Sebaran Unitkerja','url'=>array('bulanan','bulan'=>$bulan,'tahun'=>$tahun)),
	)
));
...
$this->widget('TbGridView', array(
	...
	'columns'=>array(
		...
		array('header'=>'Jml Kegiatan', 'value'=>function($data){return $data->jml_kegiatan?$data->jml_kegiatan:'-';}),
		array('header'=>'Kuantitas', 'value'=>function($data){return $data->r_kuantitas?$data->r_kuantitas:'-';}),
		array('header'=>'Kualitas','value'=>function($data){return $data->r_kualitas?$data->r_kualitas:'-';}),
		array('header'=>'Nilai CKP','value'=>function($data){return $data->nilai_ckp?$data->nilai_ckp:'-';}),
...
if(!$excel){
	echo CHtml::link('<i class="g g-download"></i> Export Excel',array('ckp_rekap','bulan'=>$bulan,'tahun'=>$tahun,'excel'=>'download'));
}

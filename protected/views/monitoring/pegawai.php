...
$this->breadcrumbs=array(
	...
	'Kegiatan Bulanan'=>array('bulanan','bulan'=>$bulan,'tahun'=>$tahun),
);

$filter = ' AND year(tgl_mulai)=year(now()) AND month(tgl_mulai)<='.$bulan.' AND month(tgl_selesai)>='.$bulan;
...
//		echo '<span class="span2">Angka Kredit </span> : '.array_sum($arr_angka_kredit).'<br>';
	...
	$t_ckp->jml_kegiatan = count($arr['kualitas']);

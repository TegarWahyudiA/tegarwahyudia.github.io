...
$this->widget('TbMenu', array(
	'type'=>'tabs',
	'items'=>array(
		array('label'=>'Pegawai','url'=>array('pegawai'),'active'=> is_null($filter)),
		array('label'=>'Mitra','url'=>array('pegawai','filter'=>'mitra'),'active'=> $filter=='mitra'),
		array('label'=>'Non Aktif','url'=>array('pegawai','filter'=>'nonaktif'),'active'=> $filter=='nonaktif'),
	)));
...
echo CHtml::link(BHtml::icon('plus-sign').'Tambah',array('pegawai_add'));
